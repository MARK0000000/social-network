...
const MySendMessageInput = React.forwardRef((props, ref, addComment) => {
  console.log(props)
  ...
  return (
    ...
    <input  ref={ref} {...props} className={classes.myInput}/>
      ...
      <path  fill-rule="evenodd" clip-rule="evenodd" d="M17 9L1.47223e-05 1L0.425812 0.0951843L17.4258 8.09518L17 9Z" fill="#6750A4"/>
