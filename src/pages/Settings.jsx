...
export default function Settings() {
  ...
  const {isLoggedIn, setIsLoggedIn, logOut} = useContext(LoggedContext)
  ...
  return (
    <section className='settings'>
      <div className='settings__item'>
        ...
        <svg onClick={() => logOut()} width="32" height="32" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
