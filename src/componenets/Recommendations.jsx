...
export default function Recommendations() {
  return (
    <section className='recommendations'>
      <article className='recommendations__article'>
      ...
      <article className='recommendations__article'>
        <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum odio in nemo adipisci ducimus unde repellendus, facere fuga voluptatem autem exercitationem, nihil quisquam a laudantium reiciendis incidunt harum aperiam ullam.</h2>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt optio, asperiores id enim sequi magni ipsam itaque veritatis ab est nihil ullam omnis doloribus! Odit dolorem a nostrum expedita ducimus.
        Saepe nulla pariatur laborum dolores libero, ratione accusantium consequatur totam ipsum iure cupiditate eaque, delectus dolor quo soluta quae dicta placeat quia ab facilis impedit sequi distinctio, alias harum. Libero?</p>
      </article>
