      ...
      <div className='modal__content infoAddModal' onClick={event => event.stopPropagation()}>
        <form onSubmit={addData}>
          <div className="infoAddModal__img-box">
            ...
            <label className='infoAddModal__label_file'  htmlFor="infoAddModalFileInput">
              <svg  className='infoAddModal__img-icon'  stroke='rgba(103, 80, 164, 0.8)' strokeWidth="1.5" width="7vh" height="7vh" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="infoAddModal__item">
            <label className="infoAddModal__label"  htmlFor='uresnameInput'>{strings.firstName}</label>
            <input ref={firstNameInput} className="infoAddModal__input" id='uresnameInput'/>
          </div>
          <div className="infoAddModal__item">
            <label className="infoAddModal__label"  htmlFor='uresnameInput'>{strings.lastName}</label>
            <input ref={lastNameInput} className="infoAddModal__input" id='uresnameInput'/>
          </div>
          <div className="infoAddModal__item">
            <label className="infoAddModal__label"  htmlFor='uresnameInput'>{strings.patronymic}</label>
            <input ref={patronymicInput} className="infoAddModal__input" id='uresnameInput'/>
          </div>
          <div className="infoAddModal__item">
            <label className="infoAddModal__label"  htmlFor='uresnameInput'>{strings.placeOfResidence}</label>
            <input ref={placeOfResidenceInput} className="infoAddModal__input" id='uresnameInput'/>
          </div>
          <div className="infoAddModal__item">
            <label className="infoAddModal__label"  htmlFor='uresnameInput'>{strings.familyStatus}</label>
          ...
          <div className="infoAddModal__item infoAddModal__item_textarea">
            <label className="infoAddModal__label"  htmlFor='uresnameInput'>{strings.tellAboutYourself}</label>
